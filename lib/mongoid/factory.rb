...
module Mongoid
  ...
  module Factory
    ...
    def replace_type(type)	
      ...
      if ['Checkin', 'FoursquareItem', 'InstagramCheckinItem', 'FacebookCheckinItem', 'FacebookImageCheckinItem', 'Text', 'Thought', 'FacebookStatusItem', 'TwitterItem', 'Image'].include?(type)   
        'Mongo'+type
      else
        type
      end    
